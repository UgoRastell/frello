 ...
 */
class getTaskListRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TaskListRepository' shared autowired service.
     *
     * @return \App\Repository\TaskListRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TaskListRepository.php';

        return $container->privates['App\\Repository\\TaskListRepository'] = new \App\Repository\TaskListRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
